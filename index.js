import {Vector3, Euler, Quaternion, Math as ThreeMath} from 'three';
  ...
  function DeviceOrientationControls( object ) {
    ...
    this.update = function() {
      ...
      var beta = scope.deviceOrientation.beta ? ThreeMath.degToRad( scope.deviceOrientation.beta ) : 0; // X'
      var gamma = scope.deviceOrientation.gamma ? ThreeMath.degToRad( scope.deviceOrientation.gamma ) : 0; // Y''
